...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen} sx={{bgcolor: 'purple', color: 'white' }}>Criar Tarefa</Button>
            <Button size="small" variant="outlined" sx={{bgcolor: 'purple', color: 'white' }} >Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
